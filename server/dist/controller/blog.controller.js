...
export const queryBlogById = async (req, res) => {
...
export const queryPublicBlogById = async (req, res) => {
    const { postId } = req.params;
    if (!postId) {
        return res.status(400).json({ message: "Post Id is required to fetch post" });
    }
...
export const queryPopularBlogs = async (req, res) => {
...
export const checkIfUserLikedBlog = async (req, res) => {
...
export const countBlogsByAuthor = async (req, res) => {
...
export const queryBlogsByAuthorId = async (req, res) => {
    const authorId = Number(req.params.authorId);
...
export const queryRecentBlogs = async (req, res) => {
    const { pageNum } = req.params;
    if (!pageNum) {
        return res
            .status(400)
...
export const likeOnBlog = async (req, res) => {
    const userId = req.user.userId;
...
export const queryAuthorsBlogs = async (req, res) => {
    const userId = req.user.userId;
    try {
